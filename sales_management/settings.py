...
INSTALLED_APPS = [
    ...
    'django.contrib.humanize',  # Ajout pour les filtres humanize
    'apps.sales',
    'apps.dashboard',
    'rest_framework',
    'corsheaders',
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'apps/dashboard/templates'],  # Ajoutez ce chemin
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
TIME_ZONE = 'Africa/Algiers'  # UTC+1, une heure de moins que Paris (UTC+2 en été)
